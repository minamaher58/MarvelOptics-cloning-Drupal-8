...
/* themes/custom/mina/templates/input--button--submit.html.twig */
class __TwigTemplate_316ae00e03ad8d7ca152590de2b168f1dcf2b9575f039d5b195bda9a912fbf15 extends \Twig\Template
{
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null)))) : (""))];
        ...
        // line 1
        $this->parent = $this->loadTemplate("input.html.twig", "themes/custom/mina/templates/input--button--submit.html.twig", 1);
    ...
    public function block_input($context, array $blocks = [])
    {
        ...
        if ((($context["icon"] ?? null) && ($context["icon_only"] ?? null))) {
            // line 35
            echo "      <button  ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => "btn-footer2", 1 => ($context["classes"] ?? null), 2 => "icon-only"], "method")), "html", null, true);
            echo " >
        ";
            // line 38
            echo "        Search
  ...
  ";
    ...
    {
        return "themes/custom/mina/templates/input--button--submit.html.twig";
    }
    ...
    {
        return array (  116 => 47,  113 => 46,  102 => 44,  91 => 42,  88 => 41,  83 => 38,  78 => 35,  75 => 34,  72 => 33,  67 => 1,  64 => 30,  63 => 29,  62 => 27,  60 => 25,  54 => 1,);
    }
...
{% spaceless %}
  ...
  {% block input %}
    {% if icon and icon_only %}
      <button  {{ attributes.addClass('btn-footer2',classes, 'icon-only') }} >
  ...
  {% endblock %}
{% endspaceless %}
", "themes/custom/mina/templates/input--button--submit.html.twig", "/var/www/html/project10/web/themes/custom/mina/templates/input--button--submit.html.twig");
    }
}
